...
def export_menu_excel(request):
    ...
    # Примеры блюд
    menu_data = [
        ['СЕТ ИЗ КОЛБАСОК К КОКТЕЙЛЯМ', 'Куриные колбаски, свино-говяжьи, охотничьи колбаски с соусами на выбор (410гр.)', 1100],
        ['ПЕРВЫЙ ШАГ', 'Авторский безалкогольный коктейль янтарно-золотистого цвета с лёгкой горчинкой (0.5л)', 350],
    ]
